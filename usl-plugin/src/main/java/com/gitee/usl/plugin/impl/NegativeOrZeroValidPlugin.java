 ...
 * @author jiahao.song
 */
public class NegativeOrZeroValidPlugin extends AbstractValidPlugin<NegativeOrZero> {
    @Override
    ...
    @Override
    protected void valid(Location location, NegativeOrZero annotation, Object actual) {

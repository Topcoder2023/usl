 ...
 * @author jiahao.song
 */
public class PositiveOrZeroValidPlugin extends AbstractValidPlugin<PositiveOrZero> {
    @Override
    ...
    @Override
    protected void valid(Location location, PositiveOrZero annotation, Object actual) {

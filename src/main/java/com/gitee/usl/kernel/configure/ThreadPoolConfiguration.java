...
public class ThreadPoolConfiguration {
    ...
    private UslExecutor uslExecutor;
    ...
    public UslExecutor getUslExecutor() {
        return uslExecutor;
    }

    public ThreadPoolConfiguration setUslExecutor(UslExecutor uslExecutor) {
        this.uslExecutor = uslExecutor;
        return this;
    }

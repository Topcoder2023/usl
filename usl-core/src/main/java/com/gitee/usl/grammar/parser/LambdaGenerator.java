...
public class LambdaGenerator implements Generator {
    ...
    private final Generator parentCodeGenerator;
    ...
    public LambdaGenerator(final ScriptEngine instance,
                           final Generator parentCodeGenerator, final Parser parser,
                           final boolean newLexicalScope,
                           final boolean inheritEnv) {
        this.params = new ArrayList<>();
        this.parentCodeGenerator = parentCodeGenerator;
        this.codeGenerator = new IRGenerator(instance);
    ...
    public LambdaFunctionBootstrap getLambdaBootstrap() {
